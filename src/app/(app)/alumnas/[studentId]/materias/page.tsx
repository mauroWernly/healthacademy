                      ...
                      <td className="py-2 pr-4">
                        <div className="flex flex-wrap items-center gap-2">
                          <form action={updateSubjectEnrollmentStatusAction} className="flex items-center gap-1">
                            ...
                            <select name="status" defaultValue={e.status} className="rounded-md border border-stone-300 px-2 py-1 text-xs">
        ...
        <Card>
          ...
          <CardContent>
            {availableOfferings.length === 0 ? (
              <p className="text-sm text-stone-500">No hay materias dictadas disponibles para agregar.</p>
            ) : (
              <form action={enrollSubjectAction} className="flex flex-wrap items-end gap-2">
                <input type="hidden" name="studentId" value={studentId} />
                <div className="flex flex-col gap-1">
                  <label className="text-xs uppercase tracking-wide text-stone-500">Materia</label>
                  <select name="subjectOfferingId" required className="rounded-md border border-stone-300 px-2 py-1.5 text-sm">
